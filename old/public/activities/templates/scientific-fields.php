    ...
    <div class="accordion science-field" id="accordion">
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                ...
                <ul class="bullet-list natural-sci">
                  ...
                  <li>Faculty of Geology and Geography</li>
                  <li>Faculty of chemistry and pharmacy</li>
                </ul>
              </div>
              <div class="col-12 col-md-6">
                <h4>research</h4>
      ...
      <div class="card social-sci">
        <div class="card-header bg-white" id="headingTwo">
          <h3 class="mb-0">
            <button class="btn btn-link collapsed text-left" type="button" data-toggle="collapse" data-target="#collapse-two"
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                ...
                <ul class="bullet-list">
                  <li>Law-economic faculty</li>
                  <li>Faculty of international relations, politics and sociology</li>
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                ...
                <ul class="bullet-list">
                  ...
                  <li>Applied physics and nanomaterials</li>
                  <li>Maths</li>
                  <li>Applied mathematics</li>
                  <li>Computer engineering</li>
                  <li>Information sysytems and technologies</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="card other-sci">
        <div class="card-header bg-white" id="headingFive">
          <h3 class="mb-0">
            <button class="btn btn-link collapsed text-left" type="button" data-toggle="collapse" data-target="#collapse-five"
        ...
        <div id="collapse-five" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
          <div class="card-body">
            <div class="row">
              <div class="col-12 col-md-6">
                <ul class="bullet-list">
                  <li>College of Economics and Social Work</li>
                  <li>Department of pre-university training</li>
                  <li>Preparatory department for foreign citizens</li>
                  <li>Training and Consulting Center «Leadership Center»</li>
                </ul>
              </div>
            </div>
          </div>
