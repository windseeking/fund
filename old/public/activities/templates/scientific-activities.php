  ...
  <div class="col-12 mx-auto">
    ...
    <div class="row mb-5">
      ...
      <div class="col-12 col-md-3 bg-white">
        <h4>See also:</h4>
        <a class="btn-custom btn-custom-outline-blue btn-block" href="http://onu.edu.ua/pub/bank/userfiles/files/science/innov-rozrob2017.doc"
           target="_blank">Scientific development</a>
        <a class="btn-custom btn-custom-outline-blue btn-block" href="http://lib.onu.edu.ua/periodicheskie-izdaniya-onu-arhiv/"
