            ...
            <div class="fs-slides">
                <div class="fs-slide" id="slider-bg-1">
                    <div class="slider-bg">
                        ...
                        <p class="lead"><?= $slider_paragraph_1; ?></p>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row numbered-list justify-content-between mb-5">
            <div class="col-10 col-md-3">
                <img src="img/number-outline-blue-1.svg" alt="">
                <p><?= $purpose_1 ?></p>
            </div>
            <div class="col-10 col-md-3">
                <img src="img/number-outline-blue-2.svg" alt="">
                <p><?= $purpose_2 ?></p>
            </div>
            <div class="col-10 col-md-3">
                <img src="img/number-outline-blue-3.svg" alt="">
                <p><?= $purpose_3 ?></p>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-md-6 d-flex align-items-stretch">
                <div class="card" style='background-image: url("img/greenhouse.jpg");' data-aos="fade-up"
                     data-aos-delay="100">
                    <div class="card-body">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                <div class="card" style='background-image: url("img/frenel.jpg");' data-aos="fade-up"
                     data-aos-delay="200">
                    <div class="card-body">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4">
                <div class="card" style='background-image: url("img/wheat.jpg");' data-aos="fade-up"
                     data-aos-delay="100">
                    <div class="card-body">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4">
                <div class="card" style='background-image: url("img/burners.png ");' data-aos="fade-up"
                     data-aos-delay="200">
                    <div class="card-body">
        ...
        <div class="row mb-5">
            ...
            <div class="col-lg-4 col-xs-10 col-md-4 mb-5 d-flex align-items-stretch">
                <div class="member mx-auto" data-aos="fade-up" data-aos-delay="100">
                    <div class="member-img">
                        <img src="img/chernetsky.jpg" class="img-fluid" alt="" width="400px">
                        <div class="social">
            ...
            <div class="col-lg-4 col-xs-10 col-md-4 mb-5 d-flex align-items-stretch">
                <div class="member mx-auto" data-aos="fade-up" data-aos-delay="200">
                    <div class="member-img">
                        <img src="img/koyen.jpg" class="img-fluid" alt="" width="400px">
                        <div class="social">
            ...
            <div class="col-lg-4 col-xs-10 col-md-4 mb-5 d-flex align-items-stretch">
                <div class="member mx-auto" data-aos="fade-up" data-aos-delay="300">
                    <div class="member-img">
                        <img src="img/dolzhenko.jpg" class="img-fluid" alt="" width="400px">
                        <div class="social">
