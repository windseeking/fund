...
<header>
            ...
            <div class="col-6">
                <div class="header-contacts">
                    <ul class="header-list">
                        <li class="header-contacts__item"><a class="header-contacts__link" href="tel:+380995250511">+380
                                99 525 05 11</a></li>
                        <li class="header-contacts__item"><a class="header-contacts__link"
                                                             href="mailto:innovationfund@onu.edu.ua"></a>innovationfund@onu.edu.ua
                        </li>
                    </ul>
                </div>
                ...
                <div class="header-nav">
                    <ul class="header-list">
                        <li class="header-nav__item"><a class="header-nav__link js-scroll-trigger" data-scroll="#abiut">О
                                фонде</a></li>
                        <li class="header-nav__item"><a class="header-nav__link js-scroll-trigger"
                                                        data-scroll="#contact">Обратная
                                связь</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="header-bottom header-bottom_home">
        ...
        <nav class="header-menu">
            <ul class="header-list">
                <li class="header-menu__item"><a class="heder-menu__link" href="">Инновации</a></li>
                <li class="header-menu__item"><a class="heder-menu__link" href="">Проекты</a></li>
                <li class="header-menu__item"><a class="heder-menu__link" href="">R&D</a></li>
                <li class="header-menu__item"><a class="heder-menu__link" href="">Партнеры</a></li>
                <li class="header-menu__item"><a class="heder-menu__link" href="">HR</a></li>
                <li class="header-menu__item"><a class="heder-menu__link" href="">Новости</a></li>
            </ul>
        </nav>

        <div class="header-btn">
            <a class="btn btn_outline_blue" href="" target="_blank">Поддержать фонд</a>
        </div>
    </div>
</header>