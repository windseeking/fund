        ...
        <div class="col-12 col-md-3">
            <div class="team__item">
                ...
                <div class="team__text">
                    <div class="team__name">Павел Коен</div>
                    <div class="team__position">Основатель и глава</div>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-3">
            <div class="team__item">
                ...
                <div class="team__text">
                    <div class="team__name">Алексей Чернецкий</div>
                    <div class="team__position">Юрист</div>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-3">
            <div class="team__item">
                ...
                <div class="team__text">
                    <div class="team__name">Максим Долженко</div>
                    <div class="team__position">Бизнес-консультант</div>
                </div>
            </div>
        </div>
    </div>
...
<!-- контакты -->
<section class="contact section_narrow section_bg section_bg_light section_border_btw">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-lg-6">
            <div class="contact__title">Фонд Поддержки Инноваций</div>
