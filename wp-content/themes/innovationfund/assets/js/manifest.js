!function (e) {
    ...
    window.webpackJsonp = function (t, u, c) {
        for (var i, a, s, f = 0, l = []; f < t.length; f++) a = t[f], o[a] && l.push(o[a][0]), o[a] = 0;
        for (i in u) Object.prototype.hasOwnProperty.call(u, i) && (e[i] = u[i]);
        for (r && r(t, u, c); l.length;) l.shift()();
        if (c) for (f = 0; f < c.length; f++) s = n(n.s = c[f]);
        return s
    };
    var t = {}, o = {4: 0};
    n.e = function (e) {
        ...
        i.type = "text/javascript", i.charset = "utf-8", i.async = !0, i.timeout = 12e4, n.nc && i.setAttribute("nonce", n.nc), i.src = n.p + "assets/js/" + e + ".js";
