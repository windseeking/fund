            ...
            <div data-am-fadeshow="next-prev-navigation">
                ...
                <div class="fs-slides">
                    <div class="fs-slide" id="slider-bg-1">
                        <div class="slider-bg">
                            <img src="<?php the_field('logo'); ?>" width="100" height="100" alt="">
                            <h1 class="xs-hide sm-hide display-3 font-weight-bold"><?php the_field('slide_1_header'); ?></h1>
                            <h2 class="md-hide lg-hide xl-hide font-weight-bold"><?php the_field('slide_1_header'); ?></h2>
                            <hr class="yellow short-center">
                            <p class="lead"><?php the_field('slide_1_par'); ?></p>
                        </div>
                    </div>

                    <div class="fs-slide" id="slider-bg-2">
                        <div class="slider-bg">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/onu.png" width="100" height="100" alt="">
                            <h1 class="xs-hide sm-hide font-weight-bold"><?php the_field('slide_2_header'); ?></h1>
                            <h2 class="md-hide lg-hide xl-hide font-weight-bold"><?php the_field('slide_2_header'); ?></h2>
                            <hr class="yellow short-center">
                            <p class="lead"><?php the_field('slide_2_par'); ?></p>
                        </div>
                    </div>

                    <div class="fs-slide" id="slider-bg-3">
                        <div class="slider-bg">
                            <h1 class="xs-hide sm-hide font-weight-bold"><?php the_field('slide_3_header'); ?></h1>
                            <h2 class="md-hide lg-hide xl-hide font-weight-bold"><?php the_field('slide_3_header'); ?> ?></h2>
                            <hr class="yellow short-center">
                            <p class="lead"><?php the_field('slide_3_par'); ?></p>
                        </div>
                    </div>

                    <div class="fs-slide" id="slider-bg-4">
                        <div class="slider-bg">
                            <h1 class="xs-hide sm-hide font-weight-bold"><?php the_field('slide_4_header'); ?></h1>
                            <h2 class="md-hide lg-hide xl-hide font-weight-bold"><?php the_field('slide_4_header'); ?></h2>
                            <hr class="yellow short-center">
                            <p class="lead"><?php the_field('slide_4_par'); ?></p>
                        </div>
                    </div>
                </div>
